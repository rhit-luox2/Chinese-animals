...
public class German implements Language {
    ...
    String[] dogInfo = { "Wissenschaftlicher Name: Canis lupus Familiaris",
            ...
            "Hund und Tiger: Hunde vertragen sich am besten mit ihren schlagfertigen Artgenossen, und Hunde bringen einen Mangel an Ego in Beziehungen mit sich, und Tiger müssen sie mit der Energie „um jeden Preis beschützen“. Sehr treue Partner und ein großes Gespür für Freundlichkeit und Recht und Unrecht. \nHund und Kaninchen: Kaninchen haben einen eher verspielten Charme, der den Hund dazu bringen soll, sich mehr zu entspannen. Sie bauen Beziehungen normalerweise auf Ehrlichkeit und Anziehung auf. Kaninchen können unsicher sein, aber die Loyalität des Hundes macht die Beziehung zu einem sicheren Ort. \nHund & Pferd: Beide sehr direkt und offenherzig. Sehr ausgeprägte Kommunikationsfähigkeiten und bringen das Beste voneinander zum Vorschein. Der Hund überzeugt das Pferd davon, dass es eher freiheitsorientiert ist, sich niederzulassen. Während der Hund von der aufgeschlossenen Persönlichkeit des Pferdes inspiriert ist.",
            "Berühmte Persönlichkeiten dieses Sternzeichens: \"Famous people who is this zodiac: Ursula von der Leyen, Anne Hathaway, Michael Jackson, George W. Bush, Zhou Enlai, Winston Churchill, Donald Trump, Elvis Presley, Kim Jong-un, and Nicki Minaj" };
    String[] dragonInfo = { "Wissenschaftlicher Name: N/A", "Lebensdauer: N/A", "Lebensraum: N/A",
            "Eine interessante Tatsache über Drachen: In China symbolisieren Drachen Reichtum, Macht und Führung, da angenommen wurde, dass chinesische Kaiser Nachkommen von Drachen seien.",
            "Wie viele Drachen gibt es auf der Welt? N / A",
            "Die Geschichte des Drachen: Der Drache war das fünfte Tierkreiszeichen. Obwohl es schneller hätte gehen sollen, hatte der Drache bei einem Dorf angehalten, um für Regen zu sorgen, und half dem Kaninchen, indem er ihn ans Ufer blies.",
            "Jahre: 1904, 1916, 1928, 1940, 1952, 1964, 1976, 1988, 2000, 2012, 2024",
            "Was sagt dieses Sternzeichen über Sie aus? Drachen gelten als mächtig, gutherzig, wohlhabend, mutig, führend und innovativ. Sie können auch prüfend, egoistisch, leicht verärgert und übermütig sein.",
            "Was sagt Ihr Sternzeichen über Ihren Erfolg aus? Drachen können fast jeden Job mit hoher Kompetenz und Effizienz erledigen. Sie können im wissenschaftlichen oder künstlerischen Bereich erfolgreich sein. Für Drachen werden Jobs im Gesundheitswesen, Unternehmer, Lehrer, Psychologen und Schriftsteller empfohlen",
            "Ihre Verträglichkeit mit anderen Tieren:",
            "Drache und Ratte: Wertschätzen die Eigenschaften des anderen trotz der Unterschiede. \nDrache und Affe: Sie holen das Beste aus einander heraus und bringen Leidenschaft und Humor in Einklang. \nDrache und Hahn: Zielstrebig und geradlinig wissen beide, was sie wollen.",
            "Berühmte Personen: Ruth Westheimer, John Lennon, Bruce Lee, Rihanna, Martin Luther King Jr., Wladimir Putin, Shakira, Jeb Bush, Christian Dior, Robert Oppenheimer, Shirley Temple, Adele, Dr. Seuss, Sandra Bullock, and Alexei Nikolaevich" };
    ...
    String[] horseInfo = { "Wissenschaftlicher Name: Equus ferus caballus", "Lebensdauer: 30 Jahre",
            "Lebensraum: Variiert von Grasland über Wälder, Berge, Feuchtgebiete, Wüsten, Tundra, Savannen, Küstenregionen, Steppen und mehr.",
            "Eine interessante Sache über Pferde: Sie waren das häufigste Transportmittel in alten Gesellschaften und gelten als eines der sechs wichtigsten Tiere in China.",
            "Wie viele Pferde gibt es auf der Welt? Ungefähr 60 Millionen",
            "Die Geschichte des Pferdes: Der Legende nach hatte das Pferd in der Antike Flügel und wurde „Heiliges Pferd“ genannt, das auf dem Boden laufen, schwimmen und fliegen konnte. Aufgrund seiner Arroganz befahl der Jadekaiser, ihm die Flügel abzuschneiden und begrub ihn unter dem Kunlun-Berg. Der menschliche Vorfahre Ren Zu befreite es später und das Pferd widmete sein Leben dem Dienst an den Menschen.",
            "Jahre: 1918, 1930, 1942, 1954, 1966, 1978, 1990, 2002, 2014, 2026",
            "Was sagt das über Sie aus? Pferde sind fröhlich, enthusiastisch, einsichtig und rücksichtsvoll.",
    ...
    String[] monkeyInfo = { "Wissenschaftlicher Name: Ceropothecidae", "Lebensdauer: bis zu 40 Jahre",
            "Lebensraum: Regenwald – auf fast allen Kontinenten",
            "Eine interessante Sache über Affen: Affen sind hochintelligente Säugetiere. Sie verstehen Zahlen und können zählen. In seltenen Fällen können sie sich vermehren.",
            "Wie viele Affen gibt es auf der Welt? 505 bekannte Arten",
            "Die Geschichte des Affen: Der Affe ist das neunte Tier des chinesischen Sternzeichens. Obwohl der Affe ein gewöhnliches Tier ist, konnte er am Großen Rennen teilnehmen, weil der Tiger dem Affen einen Gefallen schuldete, weil er ihm das Leben rettete. Der Tigerkönig war jedoch unglücklich darüber, dass er mit einem gewöhnlichen Affen verglichen wurde. Seitdem sind die beiden unvereinbar. Während des Rennens belegte der Affe den neunten Platz.",
            "ahre: 1956, 1968, 1980, 1992, 2004, 2016, 2028, 2040",
            "Was sagt dieses Sternzeichen über Sie aus? Menschen, die im Jahr des Affen geboren wurden, neigen dazu, kontaktfreudig, vorausschauend und erfinderisch zu sein. Affenpersönlichkeiten sind kreativ und unberechenbar. Sie sind von Natur aus scharfsinnig und es macht Spaß, mit ihnen zusammen zu sein. Eine Schwäche der Ratten besteht darin, dass sie bei allem, was Anstrengung erfordert, keine Geduld haben.",
            "Was sagt Ihr Sternzeichen über Ihren Erfolg aus? Affen können in den Bereichen Sport und Unterhaltung sowie in jeder Karriere erfolgreich sein, in der es darum geht, komplizierte Probleme zu lösen, beispielsweise als Detektiv oder Anwalt.",
            "Ihre Kompatibilität mit den anderen Tieren:",
            "Affe und Ratte: Sie verstehen sich gegenseitig und unterstützen sich gegenseitig. Dieses Maß an Unterstützung ist die Lösung, wenn Konflikte auftreten. \nAffe & Hund: Ihr geht beide respektvoll miteinander um und kennt die Bedürfnisse des anderen. Dieses Paar ist reif und kann gut mit Konflikten umgehen. \nAffe und Drache: Sie beide verstehen, wie wichtig es ist, einander zu schätzen und eine Bindung zueinander aufzubauen. Sie wissen, wie man miteinander arbeitet, sodass Sie lernen und sich gegenseitig helfen können, weil Sie sowohl ehrgeizig als auch positiv sind.",
    ...
    String[] oxInfo = { "Wissenschaftlicher Name: Bos taurus", "Lebensdauer: ca. 15 Jahre",
            "Lebensraum: Nordamerika, Europa, Asien und Afrika; keine Wildochsen in Südamerika und Australien",
            "Eine interessante Sache an Ochsen ist: Ochsen werden seit über 6.000 Jahren domestiziert und für landwirtschaftliche Zwecke genutzt.",
            "Wie viele Ochsen gibt es auf der Welt? Ungefähr 300 bis 400 Millionen",
            "Die Geschichte des Ochsen: Der Ochse steht an zweiter Stelle unter den chinesischen Tierkreiszeichen, weil er der Ratte half, später aber von ihr ausgetrickst wurde. Der Mythos besagt, dass der Jadekaiser erklärte, dass die Reihenfolge der Tierkreiszeichen auf der Ankunftsreihenfolge von 12 Tieren basieren würde. Ox hätte zuerst ankommen können, nahm aber freundlicherweise Rat mit. Als Rat jedoch ankam, sprang er knapp vor Ox zur Endstation und so verlor Ox den ersten Platz.",
            "Jahre: 1913, 1925, 1937, 1949, 1961, 1973, 1985, 1997, 2009, 2021, 2033",
            "Was sagt das über Sie aus? Ochsen sind treu, zuvorkommend, ausdauernd und mitfühlend",
            "Was sagt es über Ihren Erfolg aus? Ochsen sind typische Realisten, aufrecht und einfach, geeignet für Rollen wie Anwälte, Berater, Ärzte und Techniker.",
            "Ihre Kompatibilität mit den anderen Tieren:",
            "Ochse und Ratte: Ihr seid beide bereit, die familiären Pflichten zu teilen. Sie wissen, wie Sie mit Ihren komplementären Charakteren zusammenarbeiten, um sich gegenseitig bei der Arbeit, im Beruf und im Privatleben zu unterstützen. \nOchse & Schlange: Ihre Verträglichkeit gilt als hervorragend, da sie ähnliche Vorlieben haben. Dadurch können sie zusammenarbeiten und sich gut verstehen. Die Spontaneität der Schlange kann den rationalen und akribischen Ochsen inspirieren. \nOchse & Hahn: Beide Tiere denken gerne über langfristige Ziele nach. Sie haben auch materialistische Ziele, auf die sie gerne hinarbeiten, da sie beide fleißige Tierkreistiere sind.",
            "Berühmte Persönlichkeiten dieses Tierkreises: Lothar Mattaus, Walt Disney, Margaret Thatcher, Diana Spencer, Barack Obama und Bruno Mars" };
    ...
    String[] rabbitInfo = { "Wissenschaftlicher Name: Oryctolagus cuniculus", "Lebensdauer: bis zu 12 Jahre",
            "Lebensraum: Vielfalt – Wiesen, Feuchtgebiete, Grasland, Sümpfe, Berggebiete, Vulkangebiete und alle Kontinente außer der Antarktis",
            "Eine interessante Sache bei Kaninchen: Kaninchen beginnen schon in sehr jungem Alter mit der Zucht. Sie beginnen, wenn sie drei bis vier Monate alt sind.",
            "Wie viele Kaninchen gibt es auf der Welt? 200 Millionen bis 600 Millionen",
            "Die Geschichte des Hasen: Der Hase ist das vierte Tier des chinesischen Sternzeichens. Der Hase beschloss, das Rennen vor den anderen Tieren zu starten. Es war fast am Ende, aber es wurde übermütig und machte ein Nickerchen, da keine anderen Tiere in Sicht waren. Der Hase wachte auf und sah, wie der schnelle Tiger an ihm vorbeiging. Der Hase konnte mit dem schnellen Tiger und dem ausdauernden Ochsen nicht mithalten. Da sich die Ratte in den Hörnern des Ochsen versteckte, kam der Hase im Rennen auf den vierten Platz.",
            "Jahre: 1951, 1963, 1975, 1987, 1999, 2011, 2023, 2035",
    ...
    String[] roosterInfo = { "Wissenschaftlicher Name: Gallus gallusDomesticus", "Lebensdauer: 5 Jahre",
            "Lebensraum: Hähne kommen in einer Vielzahl von Lebensräumen vor, darunter Bauernhöfe, vorstädtische Hühnerställe, Wälder, Grasland und sogar Wüsten. Sie sind anpassungsfähige Lebewesen und können in unterschiedlichen Umgebungen gedeihen, vom schottischen Hochland bis zu den tropischen Regionen Asiens und Afrikas. Hähne bauen ihre Nester am liebsten an abgelegenen Stellen, etwa unter Büschen oder im hohen Gras.",
            "Eine interessante Sache: Hähne haben einen schlechten Geruchs- und Geschmackssinn, aber ein gutes Gehör.",
            "Wie viele Hähne gibt es auf der Welt? 34,4 Milliarden",
            "Die Geschichte vom Hahn: Der Hahn versuchte immer, die anderen zu besiegen. Als der Jadekaiser die Tiere für die Teilnahme am Rennen auswählte, stand der Hahn nicht auf der Liste, da er für den Menschen nicht hilfreich war. Das Pferd sagte dem Hahn, dass es seine goldene Stimme nutzen könne, um Menschen aufzuwecken. Als der Hahn es tat, waren die Menschen sehr dankbar und der Jadekaiser fügte den Hahn der Liste hinzu. Am Tag des Rennens kamen Hahn und Hund gemeinsam zum Rennen. Während des Rennens konnte der Hund nicht aufholen und platzierte sich direkt hinter dem Hahn. Auch heute noch ist der Hund wütend auf den Hahn. In der chinesischen Kultur ist das Konzept „der Hund, der dem Hahn nachjagt“ noch heute sichtbar. Viele chinesische Hunde jagen beispielsweise gerne Hähne.",
            "Jahre: 1921, 1933, 1945, 1957, 1969, 1981, 1993, 2005, 2017, 2029",
            "Was sagt das über Sie aus? Hähne sind selbstbewusst, kontaktfreudig, intelligent und optimistisch",
            "Was sagt es über Ihren Erfolg aus? Viele Hähne haben scharfe Ansichten zu aktuellen Themen und sind gut darin, Ideen zu verwirklichen. Aufgrund ihrer Beredsamkeit und ihres großen Machteifers eignen sie sich hervorragend als Politiker, Diplomaten oder Redner. Wer über weniger politisches Bewusstsein verfügt, könnte darüber nachdenken, Reiseleiter oder Schauspieler/Schauspielerin zu werden, da er kaum schüchtern ist, wenn er in der Öffentlichkeit spricht oder auftritt. Darüber hinaus haben manche Menschen, die im Jahr des Hahns geboren wurden, ein anspruchsvolles Auge für die Künste. Unter Berücksichtigung ihres Interesses am Aussehen sind sie als Modedesigner in ihrem Element.",
            "Your compatibility with the other animals:",
            "Hahn & Ochse: Beide Tiere denken gerne über langfristige Ziele nach. Sie haben auch materialistische Ziele, auf die sie gerne hinarbeiten, da sie beide fleißige Tierkreistiere sind. \nHahn und Schlange: Die Kompatibilität von Schlange und Hahn wird durch gemeinsame Ziele und Hingabe definiert. Sie haben beide gegensätzliche Persönlichkeiten, aber das Horoskop sagt aufgrund des gegenseitigen Fleißes eine günstige Beziehung voraus.",
            "Berühmte Persönlichkeiten dieses Sternzeichens: Sophie Scholl, Tom Selleck, Kelly McGillis, Jennifer Aniston, Britney Spears, Justin Timberlake und Taylor Momsen" };
    String[] snakeInfo = { "Wissenschaftlicher Name: Serpentes", "Lebensdauer: bis zu 20 Jahre",
            "Lebensraum: Jeder Lebensraum, der nicht arktisch oder subarktisch ist – tropische Wälder, trockene Wüsten, Taigas, Wälder, Wiesen",
            "Eine interessante Sache über Schlangen: Es gibt 725 Arten giftiger Schlangen, aber nur 250 von ihnen können einen Menschen mit einem Biss fressen.",
            "Wie viele Schlangen gibt es auf der Welt? Es gibt mehr als 3.000 Arten",
            "Die Geschichte der Schlange: Die Schlange ist das sechste Tier des chinesischen Sternzeichens. Vor langer, langer Zeit hatte die Schlange vier Beine, aber die Schlange war bei den Menschen unbeliebt. Als die Schlange davon hörte, fraß sie Tiere und biss Menschen. Der Jadekaiser riet der Schlange, gut zu sein, aber die Schlange lehnte ab. Daraufhin schnitt der Jadekaiser der Schlange die vier Beine ab. Die Schlange erkannte ihren Fehler und arbeitete daran, Gutes für die Menschen zu tun. Vom Drachen lernte es die Wasserkontrolle, um Überschwemmungen zu verhindern. Die Schlange wurde hinter dem Drachen platziert, weil der Jadekaiser sah, dass die Schlange ihre Fehler korrigierte.",
            "Jahre: 1953, 1965, 1977, 1989, 2001, 2013, 2025, 2037",
            ...
            "Was sagt es über Ihren Erfolg aus? Schlangen können in einer wissensbasierten Arbeit Erfolg haben, beispielsweise als Politiker, Lehrer und Psychologe. Schlangen ziehen es vor, ihre Ideen zu priorisieren, ohne darüber nachzudenken, was andere zu sagen haben. Dies wäre in einer Führungsposition hilfreich.",
            "Ihre Kompatibilität mit den anderen Tieren:",
            "Schlange und Schaf: Ihr seid beide familienorientiert. Sie können zusammenarbeiten, um eine harmonische Familie zu gründen. \nSchlange und Hund: Sie beide vertrauen und verstehen einander, um eine dauerhafte und frische Beziehung aufzubauen. \nSchlange und Affe: Ihr habt beide die Bedürfnisse des anderen. Schlangen erwarten von einem Partner Zärtlichkeit, Wärme und Unterstützung. Ein Affe kann diese Bedürfnisse erfüllen und ein weiterer Pluspunkt ist, dass Affen romantisch sind. \nSchlange und Schwein: Die Persönlichkeit des Schweins passt gut zur des Kaninchens. Kaninchen schätzen die Einfachheit und Ehrlichkeit des Schweins.",
            "Berühmte Persönlichkeiten dieses Sternzeichens: Wilhelm Röntgen, Johann Wolfgang von Goethe, J.K.Rowling, Oprah Winfrey, John F. Kennedy, Pablo Picasso und Charles Darwin" };
    String[] tigerInfo = { "Wissenschaftlicher Name: Panthera tigris",
            ...
            "Wie viele Tiger gibt es auf der Welt? Es gibt nur 4.500 Tiger, manche schätzen sogar weniger. (Tiger sind eine vom Aussterben bedrohte Tierart. Klicken Sie hier, um mehr darüber zu erfahren, wie Sie Tigern helfen können.)",
